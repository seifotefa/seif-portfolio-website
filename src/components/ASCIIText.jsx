...
class AsciiFilter {
  ...
  hue() {
    // Disabled hue rotation for black text
...
class CanvAscii {
  ...
  setRenderer() {
    ...
    // Mouse rotation disabled - no need for event listeners
  ...
  render() {
    ...
    // Disabled mouse rotation - keeping waves only
    // this.updateRotation();
  ...
  dispose() {
    ...
    // Mouse rotation disabled - no event listeners to remove
